...
// in pokemon_app/test/data/datasources/pokemon_datasource_impl_test.dart.
...
import 'package:pokemon_app/data/network/dio_provider.dart' as _i10;
...
///
/// See the documentation for Mockito's code generation for more information.
class MockDioProvider extends _i1.Mock implements _i10.DioProvider {
  MockDioProvider() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i8.Future<dynamic> get(String? endpoint) => (super.noSuchMethod(
        Invocation.method(
          #get,
          [endpoint],
        ),
